...
export { Access, IAccess } from './discord/Access';
export { All, ALL } from './discord/accesses/all';
export { Admin, ADMIN } from './discord/accesses/admin';
export { Forbidden, FORBIDDEN } from './discord/accesses/forbidden';
